...
${p}${S}`}}var L={'"':'"',"\\":"\\",n:`
`,r:"\r",t:"	"},h={u:"Invalid escape sequence"};function $(e){return N(e,0)}function N(e,o){let a=e===null?"null":Array.isArray(e)?"array":typeof e;switch(a){case"string":return k(e);case"boolean":return`${e}`;case"bigint":{let n=-(2n**63n),c=2n**63n-1n;if(e<n||e>c)throw new Error(`Integer ${e} is outside the 64-bit signed integer range`);return`${e}`}case"number":{if(!Number.isFinite(e))throw new Error(`Cannot encode ${e} as a MAML value`);let n=`${e}`;if(!n.includes(".")&&!n.includes("e")&&!Number.isSafeInteger(e))throw new Error(`Integer ${e} cannot be represented losslessly as a number, use BigInt instead`);return n}case"null":case"undefined":return"null";case"array":{let n=e.length;if(n===0)return"[]";let c=b(o+1),d=b(o),t=`[
`;for(let l=0;l<n;l++)l>0&&(t+=`
`),t+=c+N(e[l],o+1);return t+`
`+d+"]"}case"object":{let n=Object.keys(e),c=n.length;if(c===0)return"{}";let d=b(o+1),t=b(o),l=`{
`;for(let w=0;w<c;w++){w>0&&(l+=`
`);let x=n[w];l+=d+U(x)+": "+N(e[x],o+1)}return l+`
