function I(e){if(typeof e!="string")throw TypeError("Source must be a string");let o=0,a=1,n,l=!1;t();let d=w();if(g(),!l)throw new SyntaxError(f());return m(d),d;function t(){o<e.length?(n=e[o],o++):(n="",l=!0),n===`
